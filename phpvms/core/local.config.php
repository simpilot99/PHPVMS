 ...
 *
 */
define('DBASE_USER', 'a4377596_root');
define('DBASE_PASS', 'theo2806');
define('DBASE_NAME', 'a4377596_php');
define('DBASE_SERVER', 'mysql5.000webhost.com');
define('DBASE_TYPE', 'mysql');

define('TABLE_PREFIX', 'phpvms_');

define('SITE_URL', 'http://hawaiianairwayspireps.comoj.com/phpvms');
...
Config::Set('USERS_ONLINE_TIME', 15);
...
Config::Set('MAP_CENTER_LAT', '27.44979');
Config::Set('MAP_CENTER_LNG', '-138.441467');
...
Config::Set('VACENTRAL_API_KEY', 'ed956cab668d102e5880e34ce702838f');

# Jumpseat Ticket Cost Per NM
Config::Set('JUMPSEAT_COST', '.5');
