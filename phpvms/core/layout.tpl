...
<div id="innerwrapper">
	...
	<div class="box" style="text-align:center; margin-top:5px;margin-bottom:5px; height:115px;"><p>
    You are accessing this site from <?php echo $_SERVER["REMOTE_ADDR"]; ?>. <a href="http://www.hawaiianairwaysva.com" target="_blank"> Hawaiian Airways VA</a> is<a href="http://www.phpvms.net" target="_blank"> powered by phpVMS</a>. Website designed by <a href="http://zumeweb.com"> Zumeweb</a> and edited by Theo Bearman.
	<br>
	All information on this site is for fight simulation purposes only. This site is for flight logging for pilots of <a href="http://www.hawaiianairwaysva.com" target="_blank"> Hawaiian Airways VA</a> only.
 ...
 <img src="http://havatwitter.x10.mx/twitterfeed/phpvms/hava32.png" /></a>
 &nbsp
 &nbsp
 &nbsp
 <a href="https://www.facebook.com/HawaiianAirways" target="_blank">
 <img src="http://i.imgur.com/kXUppjk.png" /></a>
 </center>
<br>
Copyright &copy; 2013 <a href="http://www.hawaiianairwaysva.com" target="_blank"> Hawaiian Airways VA</a> | All Rights Reserved
 </p>
	</div>	
</div>
</body>
