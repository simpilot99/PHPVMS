...
?>
   <tr class="profile_data" onclick="location.href='<?php echo url('/schedules/details/'.$route->id);?>'"> 
    ...
    <td align="center"><span class="label label-info"><?php echo $route->aircraft; ?></span></td> 
    <td align="center"><button class="btn btn-mini btn-primary" type="button" onclick="location.href='<?php echo url('/schedules/details/'.$route->id);?>'">View &#8594;</button></td> 
</tr>
