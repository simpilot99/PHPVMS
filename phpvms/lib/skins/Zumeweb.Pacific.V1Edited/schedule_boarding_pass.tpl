...
{
?>
<h3>Requirements for Online Check-In</h3>
...
<table width="90%" class="boardingpass">
	<tr>
		...
		<td align="left"><font color="black"><h3><?php echo SITE_NAME;?></font></h3></td>
	</tr>
	<tr>
		<td colspan="2"><font color="black"><h3>Boarding Pass</font></h3></td>
	</tr>
	<tr class="thickline">
		<td colspan="2"></td>
	</tr>
