...
<a id="<?php echo $schedule->id; ?>" class="addbid" 
                                        href="<?php echo url('/schedules/addbid');?>"><button style="border-top-right-radius:0px; border-top-left-radius:0px;" class="btn btn-block btn-info" type="button">Book Flight</button></a><br />
