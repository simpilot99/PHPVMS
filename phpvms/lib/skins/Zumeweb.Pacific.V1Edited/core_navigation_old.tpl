...
<li data-toggle="tooltip" rel="tooltip" title="Home"><a href="<?php echo url('/'); ?>"> <i class="icon-home icon-white"></i></a></li>
<?php
if(!Auth::LoggedIn())
{
...
<li data-toggle="tooltip" rel="tooltip" title="Flight Info"><a href="<?php echo url('/acars') ?>"><i class="icon-map-marker icon-white"></i></a></li>
